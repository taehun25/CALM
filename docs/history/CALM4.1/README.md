# CALM 4.1 research archive

> This README and the adjacent `CALM/` source snapshot preserve the previous
> CALM 4.1 public release. Paths and commands below reflect that historical
> repository layout. Use the repository-root `CALM/` directory for CALM 4.3.
